    ...
    <section id="gallery" className="bg-muted py-16">
      <div className="section-container">
        <div className="text-center mb-12 animate-on-scroll">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-owl-darkbrown">Галерея филинов</h2>
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            Величественные и загадочные, филины покоряют своей красотой и грацией
          </p>
        </div>

        <div className="image-grid">
          {images.map((image, index) => (
            <Card key={index} className="overflow-hidden shadow-md hover:shadow-xl transition-shadow animate-on-scroll">
